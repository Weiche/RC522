 ...
 * Definitions
 ******************************************************************************/
#define MAX_LEN 16   // Largo m醲imo de la matriz

//MF522 comando palabra
#define PCD_IDLE              0x00               // NO action; Y cancelar el comando
#define PCD_AUTHENT           0x0E               // autenticaci髇 de clave
#define PCD_RECEIVE           0x08               // recepci髇 de datos
...
#define PICC_REQIDL           0x26               // 羠ea de la antena no est�tratando de entrar en el estado de reposo
#define PICC_REQALL           0x52               // Todas las cartas para encontrar el 醨ea de la antena
#define PICC_ANTICOLL         0x93               // anti-colisi髇
#define PICC_SElECTTAG        0x93               // elecci髇 de tarjeta
...
//MF522 C骴igo de error de comunicaci髇 cuando regres�
#define MI_OK                 0
